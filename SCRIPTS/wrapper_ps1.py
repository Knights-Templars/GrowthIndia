...
sys.path.append('/home/anirban.dutta/ZOGY')
import ldactools as aw
import py_zogy
warnings.simplefilter('ignore')
astrom_scamp = '/home/anirban.dutta/ZOGY/scamp.conf'
astrom_sex = '/home/anirban.dutta/ZOGY/astrom.sex'
astrom_swarp = '/home/anirban.dutta/ZOGY/config.swarp'
psf_config_name = '/home/anirban.dutta/ZOGY/photom.psfex'
sexpsfparam = '/home/anirban.dutta/ZOGY/sexpsf.param'
...
def run_swarp(scifilename, reffilename, pxscale, imgpixsize, ra, dec):
	...
	swarp_command = "swarp %s -c %s -RESAMPLE Y -RESAMPLE_DIR . -SUBTRACT_BACK Y -WEIGHT_TYPE MAP_WEIGHT -WEIGHT_IMAGE %s -PIXELSCALE_TYPE MANUAL -PIXEL_SCALE %.3f -IMAGE_SIZE %d -CENTER %.8f,%.8f -COMBINE Y -IMAGEOUT_NAME %s -WEIGHTOUT_NAME %s"%(reffilename, astrom_swarp, reffilename + '.weight', pxscale, imgpixsize, ra , dec, reffilename + '.resamp', reffilename + '.resamp.weight')
